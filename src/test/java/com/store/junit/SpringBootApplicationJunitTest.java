...
public class SpringBootApplicationJunitTest {
	...
	{				
		try {
			...
			customersDTO.setId(Long.valueOf(2));
			customersDTO.setCustomerId(Long.valueOf(11489));
		    ...
		    orderItemsDTO11.setId(Long.valueOf(5));
		    orderItemsDTO11.setOrderItemsId(Long.valueOf(4));
		    ...
		    orderItemsDTO12.setId(Long.valueOf(6));
		    orderItemsDTO12.setOrderItemsId(Long.valueOf(5));
		    ...
		    orderItemsDTO21.setId(Long.valueOf(4));
		    orderItemsDTO21.setOrderItemsId(Long.valueOf(4));
